...
public class GuitarHero {
    public static GuitarString[] keyboards = new GuitarString[37];
    public static double PLUS = 770.0/36;
    static String keyboard = "q2we4r5ty7u8i9op-[=zxdcfvgbnjmk,.;/' ";
    public static double begin = 110.0;
    public static void init(){
        for(int i = 0;i<37;i+=1){
            begin += PLUS;
            char name = keyboard.charAt(i);
            keyboards[i] = new GuitarString(begin);
            keyboards[i].name = name;
        }
    }
    ...
    public static void main(String[] args) {
        init();
        int inx = 0;
        String score = "q2we4r5ty7u8i9op-[=zxdcfvgbnjmk,.;/' ";
        while (true) {
